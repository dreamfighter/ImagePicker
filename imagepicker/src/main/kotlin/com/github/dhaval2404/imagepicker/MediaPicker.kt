...
open class MediaPicker {
    ...
    companion object {
        ...
        internal const val EXTRA_VIDEO = "extra.video"
    ...
    class Builder(private val activity: Activity) {
        ...
        /**
         * include capture or pick video
         */
        fun enableVideo(video:Boolean):Builder{
            this.video = video
            return this
        }
            ...
            return Bundle().apply {
                ...
                if(video){
                    if(mimeTypes.isEmpty()){
                        ...
                        mimeTypes = mimeTypes.plusElement("video/*")
                    }
                    Log.d("MIMES_BUNDLE",mimeTypes.joinToString(","))
                }
